<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row
              style="width: 100%">
      <el-table-column width="280px" align="center" label="资源编码">
      ...
      <el-table-column width="190px" align="center" label="资源方法类型">
        <template scope="scope">
      <span>
        {{scope.row.method}}</span>
        </template>
      </el-table-column>
      <el-table-column width="240px" align="center" label="资源地址">
        <template scope="scope">
      <span>
        {{scope.row.uri}}</span>
        </template>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :model="form" :rules="rules" ref="form" label-width="150px">
        ...
        <el-form-item label="资源方法类型" prop="method">
          <el-select class="filter-item" v-model="form.method" placeholder="请输入资源方法类型">
